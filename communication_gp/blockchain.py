...
class Blockchain(object):
    ...
    def create_genesis_block(self):
        ...
        The gensis block is the anchor of the chain. It must be identical for all nodes
        or consensus will fail.
...
def new_block():
    ...
    # Validate the block
    # Index is exactly one greater than last in the chain
